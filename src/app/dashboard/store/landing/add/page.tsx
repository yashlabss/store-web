...
import ChooseProductTypeClient from "../../../../../components/store/ChooseProductTypeClient";
...
const REDIRECT_LOGIN = "/auth/login?redirectTo=/dashboard/store/landing/add";
...
function ChooseLandingTypePageInner() {
...
export default function ChooseLandingTypePage() {
  return (
    <Suspense fallback={<LoadingShell />}>
      <ChooseLandingTypePageInner />
    </Suspense>
  );
}
